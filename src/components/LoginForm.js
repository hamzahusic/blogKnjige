    ...
    return ( 
                <div className="mx-auto max-w-screen-xl px-4 py-20 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-lg">
                        ...
                        Ukoliko želite objaviti vaš blog prvo se morate prijaviti! Samo admin ove stranice može objavljivati blogove.
                        </p>
                        ...
                        >
                        <p className="text-center text-lg font-medium">Logujte se na vaš admin nalog</p>
                        ...
                        <div>
                            ...
                            <span
                                onClick={() => setPassBtn(passBtn === "text" ? "password" : "text")}
